...
wfiltered_removegm_nii = connectivity_filter( ...
	out_dir, wcradfmri_nii, rp_txt, gray_nii, white_nii, csf_nii, tr, ...
	slorder, num_initial_vols_to_drop, ...
	bandpasslo_hz, bandpasshi_hz, FD, DVARS, [], ...
	mot_PCs, motderiv_PCs, wmcsf_PCs, ...
	1, project, subject, session, [scan ' MNI'] ...
	);
...
wfiltered_keepgm_nii = connectivity_filter( ...
	out_dir, wcradfmri_nii, rp_txt, gray_nii, white_nii, csf_nii, tr, ...
	slorder, num_initial_vols_to_drop, ...
	bandpasslo_hz, bandpasshi_hz, FD, DVARS, [], ...
	mot_PCs, motderiv_PCs, wmcsf_PCs, ...
	0, project, subject, session, [scan ' MNI'] ...
	);
